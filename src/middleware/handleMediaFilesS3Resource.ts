...
/**
 * @param fields - [{ name: "profilePicture", maxCount: 1 }, { name: "certificationMedia", maxCount: 5 },{ name: "fullView", maxCount: 1 },{ name: "sideView", maxCount: 1},{ name: "frontView", maxCount: 1 }]
 * @param options - { optional?: boolean } // if true, skips error when no files are uploaded
 */
export const handleMediaFilesS3Resource = (
  fields: any = [],
